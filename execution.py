...
#         print("Server Error: {msg}".format(msg))
...
#                 msg.orderId not in self.fill_dict:
...
#         print("Server Response: {type}, {msg}\n".format(msg.typeName, msg))
...
#     def create_contact(self, symbol, sec_type, exch, prim_exch, curr):
#         """
...
#         """
#         Create an entry in the Fill Dictionary that lists
...
#             "exchange": msg.contact.m_exchange,
...
#         places onto the events queue subsequent to an order
#         being filled.
#         """
...
#         and submit it to IB via their API.
